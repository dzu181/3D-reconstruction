...
imagePoints1 = detectMinEigenFeatures(rgb2gray(I1udi), 'MinQuality', 0.01);
...
EIGENinlierPoints1 = matchedPoints1(epipolarInliers, :);
EIGENinlierPoints2 = matchedPoints2(epipolarInliers, :);
