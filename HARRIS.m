...
imagePoints1 = detectHarrisFeatures(rgb2gray(I1udi), 'MinQuality', 0.01);
...
HARRISinlierPoints1 = matchedPoints1(epipolarInliers, :);
HARRISinlierPoints2 = matchedPoints2(epipolarInliers, :);
